...
/* application.yml:
##########################################################
# Utilizar quando classe OracleConfiguration estiver ativa
# (HikariCP está oferecendo melhor performance)
#    oracle:
#        url: jdbc:oracle:thin:@//teste.com/xyz
#        username: ????
#        password: ????
...
#datasource: 
#    url: jdbc:oracle:thin:@//wagnersoft.com.br:1521/BD_PRODUCAO
#    username: babilonia 
#    password: xyz
#    hikari:
#        poolName: DB_POOL 
